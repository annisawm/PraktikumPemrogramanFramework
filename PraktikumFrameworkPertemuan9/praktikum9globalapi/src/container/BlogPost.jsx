...
class BlogPost extends Component{
    ...
    ambilDataDariServerAPI = () => {
        fetch(`http://localhost:3003/posts?_sort=id&_order=desc`) // alamat URL API yang ingin kita ambil datanya    
        ...
        handleHapusArtikel = (data) => {    // fungsi untuk menghapus
            fetch(`http://localhost:3003/posts/${data}`, {method: 'DELETE'}) // alamat URL API yang akan dihapusD
