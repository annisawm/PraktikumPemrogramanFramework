                ...
                return (
                    <div>
                        <div className="container mb-5">
                            <h2 className="text-center">FORM DATA MAHASISWA</h2>
                        ...
                        <div class="row container-fluid text-center">
                            <div className="col-1 border border-dark bg-info"><b>NIM</b></div>
                            <div className="col-2 border border-dark bg-info"><b>NAMA</b></div>
                            <div className="col-1 border border-dark bg-info"><b>NO HP</b></div>
                            <div className="col-5 border border-dark bg-info"><b>ALAMAT</b></div>
                            <div className="col-1 border border-dark bg-info"><b>ANGKATAN</b></div>
                            <div className="col-1 border border-dark bg-info"><b>STATUS</b></div>
                            <div className="col-1 border border-dark bg-info"><b>AKSI</b></div>
                        </div>
                        {
